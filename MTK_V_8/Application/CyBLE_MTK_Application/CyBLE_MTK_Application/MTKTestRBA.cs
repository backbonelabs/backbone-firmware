...
{
    public class MTKTestRBA : MTKTest
    {
        public MTKTestRBA() : base()
        {
            Init();
        }

        public MTKTestRBA(LogManager Logger)
            : base(Logger)
        {
            Init();
        }

        public MTKTestRBA(LogManager Logger, SerialPort MTKPort, SerialPort DUTPort)
...
*/
        ...
        private MTKTestError RunTestUART()
        {
            ...
            {
                TempValue[i] = CommandResults[i].ToUpper();
                TempParameter[i] = "BDA#" + i.ToString();
                bda += TempValue[i] + " ";
            }
