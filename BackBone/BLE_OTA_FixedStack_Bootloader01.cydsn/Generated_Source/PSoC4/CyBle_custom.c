...
const CYBLE_CUSTOMS_T cyBle_customs[0x01u] = {
    ...
    /* BackBone service */
    {
        0x0018u, /* Handle of the BackBone service */ 
        {

            /* Write Data characteristic */
            {
                0x001Au, /* Handle of the Write Data characteristic */ 
            ...
            {
                0x001Eu, /* Handle of the Accelerometer characteristic */ 
            ...
            {
                0x0022u, /* Handle of the Gyroscope characteristic */ 
            ...
            {
                0x0026u, /* Handle of the Pedometer characteristic */ 
            ...
            {
                0x002Au, /* Handle of the ConfigData characteristic */ 
