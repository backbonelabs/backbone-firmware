...
static const uint8 keyBuffer[AES_KEY_SIZE]     = { 0x57, 0x02, 0x68, 0xB5, 0x03, 0xE6, 0x06, 0x48,
                                                   0x04, 0xAF, 0xE5, 0x9A, 0x3E, 0x5C, 0x7A, 0x92 };
static const uint8 nonceBuffer[AES_NONCE_SIZE] = { 0x4C, 0x39, 0x3B, 0xBB, 0xA0, 0x91, 0xAC, 0xD6,
                                                   0x73, 0x7E, 0x4F, 0xF0, 0xCA };
/* AES-CBC state data */
