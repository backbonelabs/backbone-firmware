...
#define MotorPWM_GetInterruptSource() MotorPWM_ReadStatusRegister()
    ...
    uint16 MotorPWM_ReadCapture(void) ;
...
void    MotorPWM_WritePeriod(uint16 period)
        ;
uint16 MotorPWM_ReadPeriod(void) ;
    ...
    void    MotorPWM_WriteCompare1(uint16 compare)
            ;
    uint16 MotorPWM_ReadCompare1(void) ;
    void    MotorPWM_WriteCompare2(uint16 compare)
            ;
    uint16 MotorPWM_ReadCompare2(void) ;
#endif /* (MotorPWM_UseOneCompareMode) */
...
#define MotorPWM_INIT_COMPARE_VALUE1        (20u)
...
******************************** */
   ...
   #define MotorPWM_RT1_PTR                 ( (reg8 *)  MotorPWM_PWMHW__RT1)
       ...
       #if(MotorPWM_PWMModeIsCenterAligned)
           #define MotorPWM_PERIOD_LSB      (*(reg8 *)  MotorPWM_PWMUDB_sP16_pwmdp_u0__D1_REG)
           #define MotorPWM_PERIOD_LSB_PTR  ((reg8 *)   MotorPWM_PWMUDB_sP16_pwmdp_u0__D1_REG)
       #else
           #define MotorPWM_PERIOD_LSB      (*(reg8 *)  MotorPWM_PWMUDB_sP16_pwmdp_u0__F0_REG)
           #define MotorPWM_PERIOD_LSB_PTR  ((reg8 *)   MotorPWM_PWMUDB_sP16_pwmdp_u0__F0_REG)
       #endif /* (MotorPWM_PWMModeIsCenterAligned) */

       #define MotorPWM_COMPARE1_LSB        (*(reg8 *)  MotorPWM_PWMUDB_sP16_pwmdp_u0__D0_REG)
       #define MotorPWM_COMPARE1_LSB_PTR    ((reg8 *)   MotorPWM_PWMUDB_sP16_pwmdp_u0__D0_REG)
       #define MotorPWM_COMPARE2_LSB        (*(reg8 *)  MotorPWM_PWMUDB_sP16_pwmdp_u0__D1_REG)
       #define MotorPWM_COMPARE2_LSB_PTR    ((reg8 *)   MotorPWM_PWMUDB_sP16_pwmdp_u0__D1_REG)
       #define MotorPWM_COUNTERCAP_LSB      (*(reg8 *)  MotorPWM_PWMUDB_sP16_pwmdp_u0__A1_REG)
       #define MotorPWM_COUNTERCAP_LSB_PTR  ((reg8 *)   MotorPWM_PWMUDB_sP16_pwmdp_u0__A1_REG)
       #define MotorPWM_COUNTER_LSB         (*(reg8 *)  MotorPWM_PWMUDB_sP16_pwmdp_u0__A0_REG)
       #define MotorPWM_COUNTER_LSB_PTR     ((reg8 *)   MotorPWM_PWMUDB_sP16_pwmdp_u0__A0_REG)
       #define MotorPWM_CAPTURE_LSB         (*(reg8 *)  MotorPWM_PWMUDB_sP16_pwmdp_u0__F1_REG)
       #define MotorPWM_CAPTURE_LSB_PTR     ((reg8 *)   MotorPWM_PWMUDB_sP16_pwmdp_u0__F1_REG)
        ...
        #else
            #if(MotorPWM_PWMModeIsCenterAligned)
               #define MotorPWM_PERIOD_LSB      (*(reg16 *) MotorPWM_PWMUDB_sP16_pwmdp_u0__16BIT_D1_REG)
               #define MotorPWM_PERIOD_LSB_PTR  ((reg16 *)  MotorPWM_PWMUDB_sP16_pwmdp_u0__16BIT_D1_REG)
            #else
               #define MotorPWM_PERIOD_LSB      (*(reg16 *) MotorPWM_PWMUDB_sP16_pwmdp_u0__16BIT_F0_REG)
               #define MotorPWM_PERIOD_LSB_PTR  ((reg16 *)  MotorPWM_PWMUDB_sP16_pwmdp_u0__16BIT_F0_REG)
            #endif /* (MotorPWM_PWMModeIsCenterAligned) */

            #define MotorPWM_COMPARE1_LSB       (*(reg16 *) MotorPWM_PWMUDB_sP16_pwmdp_u0__16BIT_D0_REG)
            #define MotorPWM_COMPARE1_LSB_PTR   ((reg16 *)  MotorPWM_PWMUDB_sP16_pwmdp_u0__16BIT_D0_REG)
            #define MotorPWM_COMPARE2_LSB       (*(reg16 *) MotorPWM_PWMUDB_sP16_pwmdp_u0__16BIT_D1_REG)
            #define MotorPWM_COMPARE2_LSB_PTR   ((reg16 *)  MotorPWM_PWMUDB_sP16_pwmdp_u0__16BIT_D1_REG)
            #define MotorPWM_COUNTERCAP_LSB     (*(reg16 *) MotorPWM_PWMUDB_sP16_pwmdp_u0__16BIT_A1_REG)
            #define MotorPWM_COUNTERCAP_LSB_PTR ((reg16 *)  MotorPWM_PWMUDB_sP16_pwmdp_u0__16BIT_A1_REG)
            #define MotorPWM_COUNTER_LSB        (*(reg16 *) MotorPWM_PWMUDB_sP16_pwmdp_u0__16BIT_A0_REG)
            #define MotorPWM_COUNTER_LSB_PTR    ((reg16 *)  MotorPWM_PWMUDB_sP16_pwmdp_u0__16BIT_A0_REG)
            #define MotorPWM_CAPTURE_LSB        (*(reg16 *) MotorPWM_PWMUDB_sP16_pwmdp_u0__16BIT_F1_REG)
            #define MotorPWM_CAPTURE_LSB_PTR    ((reg16 *)  MotorPWM_PWMUDB_sP16_pwmdp_u0__16BIT_F1_REG)
        #endif /* (CY_PSOC3) */
   ...
   #define MotorPWM_COUNTERCAP_LSB_PTR_8BIT ( (reg8 *)  MotorPWM_PWMUDB_sP16_pwmdp_u0__A1_REG)
