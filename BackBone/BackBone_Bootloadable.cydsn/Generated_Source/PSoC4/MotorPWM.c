...
void MotorPWM_WritePeriod(uint16 period) 
{
    ...
    *******************************************************************************/
                                       ...
                                       
    {
            ...
            #else
                CY_SET_REG16(MotorPWM_COMPARE2_LSB_PTR, (compare + 1u));
            #endif /* (MotorPWM_UsingFixedFunction) */
    ...
    *******************************************************************************/
    ...
    {
        #if(MotorPWM_UsingFixedFunction)
            return ((uint16)CY_GET_REG16(MotorPWM_COMPARE1_LSB_PTR));
        #else
            return (CY_GET_REG16(MotorPWM_COMPARE1_LSB_PTR));
        #endif /* (MotorPWM_UsingFixedFunction) */
    }
    ...
    *******************************************************************************/
    ...
    {
        return (CY_GET_REG16(MotorPWM_COMPARE2_LSB_PTR));
    }
...
{
    #if(MotorPWM_UsingFixedFunction)
        return ((uint16)CY_GET_REG16(MotorPWM_PERIOD_LSB_PTR));
    #else
        return (CY_GET_REG16(MotorPWM_PERIOD_LSB_PTR));
    #endif /* (MotorPWM_UsingFixedFunction) */
}
